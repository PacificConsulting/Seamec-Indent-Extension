table 50040 "Requisition Archive Header"
{
    ...
    fields
    {
        ...
        {
            OptionMembers = Open,Released,Closed,"Pending For Approval","First Approval",Cancel;//,Approved;
            OptionCaption = 'Open,Released,Closed,Pending For Approval,First Approval,Cancel';//,Approved';
            Editable = false;
        }
        ...
        field(50500; "Deleted By"; Code[100])
        {

        }
        field(50501; "Deleted Date"; Date)
        {
