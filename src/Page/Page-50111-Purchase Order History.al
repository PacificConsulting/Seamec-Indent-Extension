page 50111 "Purchase Order History"
{
    ApplicationArea = Basic, Suite;
    Caption = 'Purchase Order History List';
    CardPageID = "PO History";
        ...
        area(processing)
        {
            ...
            group(Action10)
            {
                ...
                action(Release)
                {
                    ...
                    begin
                        CurrPage.SetSelectionFilter(PurchaseHeader);
                        //Rec.PerformManualRelease(PurchaseHeader); //PCPL-25/270723
                    end;
                }
                action(Reopen)
                {
                    ...
                    begin
                        CurrPage.SetSelectionFilter(PurchaseHeader);
                        //Rec.PerformManualReopen(PurchaseHeader);      //PCPL-25/270723
                    end;
                }
            }
            group("F&unctions")
            ...
            group(Action12)
            {
                ...
                action("Create &Whse. Receipt")
                {
                    ...
                    begin
                        //Rec.PerformManualRelease();   //PCPL-25/270723
            ...
            group("P&osting")
            {
                ...
                action(PostAndPrint)
                {
                    ...
                    trigger OnAction()
                    begin
                        //SendToPosting(CODEUNIT::"Purch.-Post + Print");//PCPL-25/270723
                    end;
                }
                action(PostBatch)
                {
