page 50115 "Requisition Archive List"
{
    // version RSPL/INDENT/V3/001
    Caption = 'Requisition Archive Header List';   //PCPL-300823
    //Caption = 'Requisition Archive List';
    CardPageID = "Requisition Archive";
    PageType = List;
    SourceTable = "Requisition Archive Header";
    SourceTableView = SORTING("No.", "Entry Type")
                      WHERE(Status = FILTER(Cancel));
    ApplicationArea = all;
    UsageCategory = Lists;
