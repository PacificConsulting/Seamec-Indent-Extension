        ...
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Variant Code"; Rec."Variant Code")
                {
                    ...
                    begin
                        ...
                        /*if Rec."Variant Code" = '' then
                            VariantCodeMandatory := Item.IsVariantMandatory(Rec.Type = Type::Item, Rec."No.");*/ //PCPL-25/280723
                    end;
                }
                ...
                field(Description; Rec.Description)
                {
                    ...
                    trigger OnValidate()
                    begin
                        //Rec.RestoreLookupSelection();  //PCPL-25/280723
                    ...
                    begin
                        //Rec.SaveLookupSelection(Selected);   //PCPL-25/280723
                    end;
                }
                ...
                field(Quantity; Rec.Quantity)
                {
                    ...
                    Editable = NOT IsBlankNumber;
                    Enabled = NOT IsBlankNumber;
                    ShowMandatory = (Rec.Type <> Type::" ") AND (Rec."No." <> '');
                ...
                {
                    ApplicationArea = Suite;
                    Enabled = (Rec.Type <> Rec.Type::"Fixed Asset") AND (Rec.Type <> Type::" ");
            ...
            group("F&unctions")
            {
                ...
                action("Attach to Inventory Item Line")
                {
                    ...
                    begin
                        ...
                        //Rec.AttachToInventoryItemLine(SelectedPurchLine);  //PCPL-25/280723
                    end;
                }
                action(Reserve)
                {
